...
(function (e, t, n) {
    ...
    (function (e, t, n, r) {
        ...
        var i = e(n), s = e.mobile.support.touch, o = s ? "touchstart" : "mousedown", u = s ? "touchend" : "mouseup", a = s ? "touchmove" : "mousemove";
        e.each("touchstart touchmove touchend tap taphold swipe swipeleft swiperight".split(" "), function (t, n) {
            e.fn[n] = function (e) {
            ...
            tapholdThreshold: 750, emitTapOnTaphold: !0, setup: function () {
                ...
                n.bind("vmousedown", function (s) {
                    ...
                    function l() {
                        a(), n.unbind("vclick", c).unbind("vmouseup", a), i.unbind("vmousecancel", l)
                    }

                    function c(e) {
                        l(), !r && o === e.target ? f(t, "tap", e) : r && e.preventDefault()
                    }

                    r = !1;
                    if (s.which && s.which !== 1)return !1;
                    var o = s.target, u;
                    n.bind("vmouseup", a).bind("vclick", c), i.bind("vmousecancel", l), u = setTimeout(function () {
                        e.event.special.tap.emitTapOnTaphold || (r = !0), f(t, "taphold", e.Event("taphold", {target: o}))
            ...
            handleSwipe: function (t, n, r, i) {
                if (n.time - t.time < e.event.special.swipe.durationThreshold && Math.abs(t.coords[0] - n.coords[0]) > e.event.special.swipe.horizontalDistanceThreshold && Math.abs(t.coords[1] - n.coords[1]) < e.event.special.swipe.verticalDistanceThreshold) {
                    ...
                    return f(r, "swipe", e.Event("swipe", {
                        ...
                        swipestart: t,
                        swipestop: n
                    }), !0), f(r, s, e.Event(s, {target: i, swipestart: t, swipestop: n}), !0), !0
                }
                return !1
            },
            eventInProgress: !1,
            setup: function () {
                ...
                t = e.data(this, "mobile-events"), t || (t = {length: 0}, e.data(this, "mobile-events", t)), t.length++, t.swipe = s, s.start = function (t) {
                    ...
                    var r, o = e.event.special.swipe.start(t), f = t.target, l = !1;
                    s.move = function (t) {
        ...
        }, e.each({taphold: "tap", swipeleft: "swipe.left", swiperight: "swipe.right"}, function (t, n) {
            e.event.special[t] = {
                setup: function () {
