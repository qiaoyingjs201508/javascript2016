 ...
 */
(function ping() {
    var d = document, bd = d.body;
    var t = new Date();
    var v = "http://trace.m1905.cn/collect.gif?";
    ...
    try {
        ...
        var _tmp = tu();
        s(v + _tmp);
        var u = ["http://blog.1905.com/list.php", "http://www.1905.com/", "http://www.1905.com/vod/"];
        for (var a in u) {
            if (document.location == u[a]) {
                B(v + _tmp);
                break
            }
        }
    ...
    function ge() {
        var r = "", a = b = c = h = e = f = g = "-", i = 0, n = navigator;
        try {
            if (self.screen) {
    ...
    function loadot() {
        ...
        document.write(unescape("%3Cscript src='" + _dmProtocol + "js.static.m1905.cn/pingd_other.js' type='text/javascript'%3E%3C/script%3E"))
    }
})();